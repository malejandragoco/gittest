...
script2000="convert ~/$1.jpg -quality 60 ~/$12000.jp2"
...
for Rpis in ${Raspberrys} ; do
	...
	if [ $? -eq 0 ] #$?Da el estatus de salida del coma anterior
		then
...
if [ $Counter -eq 6 ] #$?Da el estatus de salida del comando anterior
		then
			...
			scp pi1@192.168.2.111:~/$12000.jp2  /home/tg1628/Documentos/Rasp1/ 
			scp pi2@192.168.2.112:~/$12000.jp2  /home/tg1628/Documentos/Rasp2/ 
			scp pi3@192.168.2.113:~/$12000.jp2  /home/tg1628/Documentos/Rasp3/ 
			scp pi4@192.168.2.114:~/$12000.jp2  /home/tg1628/Documentos/Rasp4/ 
			scp pi5@192.168.2.115:~/$12000.jp2  /home/tg1628/Documentos/Rasp5/
			bash ./BorrarT.sh $1
			bash ./BorrarT2.sh $1
